...
- There are limited amounts of datasets for beer analytics. Here are some examples:
    ...
    - **Data analysis projects of beer**: [yhat Beer Advocate Recommender](http://blog.yhat.com/posts/recommender-system-in-r.html), [Crowd-sourced Beer Distrobution Map](http://www.seekabrew.com/distro/index.html)
