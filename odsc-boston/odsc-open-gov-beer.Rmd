...
```{r}
data.frame(head(beermaterials, n = 3))
```
...
- Data cleaning & parsing date mistakes with `stringr`: `"101/01/1951"`
...
- Open Government Data portals, such as [data.gov](data.gov) offer a platform to share data
